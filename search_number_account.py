...
def main():
    ...
    for customer in customers:
        ...
        if not found_rows:
            print(f"Nie znaleziono żadnych operacji dla klienta o ID: {customer.id}")
        else:
            print(f"Operacje dla klienta o ID: {customer.id} i numerze konta bankowego: {account_number}")
